...
<ul class="container widefat fixed inline">
    <li class="button" data-tab="profile"><?php print __('Profile','coders_repository') ?></li>
    <li class="button" data-tab="subscriptions"><?php print __('Subscriptions','coders_repository') ?></li>
    <li class="button" data-tab="points"><?php print __('Points','coders_repository') ?></li>
</ul>
<div class="container widefat fixed">
        ...
        <form name="new-account" method="post" action="<?php print $this->save_form_url ?>">
            <table class="table widefat fixed">
                <thead>
                    <tr>
                        <th>
                            <h2 class="centered"><?php print __('Profile','coders_repository'); ?></h2>
                        </th>
                        <th>
    ...
    <div class="panel" data-tab="points">
        <table class="widefat fixed table">
            <thead>
                <tr>
                    <th colspan="3"><h2><?php print __('Points','coders_repository') ?></h2></th>
                </tr>
                <tr>
                    <th><?php print __('Date','coders_repository') ?></th>
                    <th><?php print __('Type','coders_repository') ?></th>
                    <th><?php print __('Amount','coders_repository') ?></th>
                </tr>
            </thead>
            <tbody>
            ...
            <tfoot>
                <tr>
                    <td colspan="2">
                        <strong class="right"><?php print __('Total','coders_repository') ?></strong>
                    </td>
                    <td>
