...
<table class="settings widefat fixed">
    <thead>
        <tr>
            <th colspan="2"><h2><?php print __('Section','coders_repository') ?></h2></th>
        </tr>
    </thead>
    <tbody>
        <tr>
    ...
    <tfoot>
        <tr>
            <td colspan="2">
                <button type="submit" name="_action" value="save" class="button button-primary right"><?php
                    print __('Save','coders_repository') ?></button>
            </td>
        </tr>
    </tfoot>
</table>
